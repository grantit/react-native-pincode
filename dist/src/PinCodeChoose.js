...
class PinCodeChoose extends React.PureComponent {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: [
            ...
            this.state.status === PinCode_1.PinStatus.confirm && (React.createElement(react_native_1.View, { style: styles.footerContainer }, this.props.footerComponent(this.onPressedFinish)))));
    }
}
